...
function updateTimer() {
  const targetDate = new Date("november 21, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541121871576'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541121871576'; // Número para el primer botón
  const recipientNumber2 = '541121871576'; // Número para el segundo botón
